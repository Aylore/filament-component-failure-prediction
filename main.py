...
def main(df_path):
    ...
    ## Initialize models
    train_model_large = ModelTraining(model_large_init , poly=False)
    train_model_small = ModelTraining(model_small_init , poly=False , small=True)
